...
public final class ItemUtil {
	...
	@Contract("_, _ -> new")
	public static @NotNull ItemStack getItem(@NotNull Material material, @NotNull Component @NotNull ... text) {
		return getItem(material, List.of(text));
	}

	@Contract("_, _ -> new")
	public static @NotNull ItemStack getItem(@NotNull Material material, @NotNull List<Component> text) {
